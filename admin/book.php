  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Librat</li>
        <li class="active">Lista e Librave</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Shto Liber</a>
                ...
                <tbody>
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){
                      if($row['status']){
                        $status = '<span class="label label-danger">Huazuar</span>';
                      }
                      else{
                        $status = '<span class="label label-success">gjendje</span>';
                      }
                      echo "
                        <tr>
                          <td>".$row['name']."</td>
